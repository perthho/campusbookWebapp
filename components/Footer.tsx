        ...
        <div className="grid md:grid-cols-5 gap-10 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex flex-col gap-2">
              <a href="/api/download" target="_blank" rel="noreferrer" className="flex items-center gap-2 px-3 py-2 bg-white/10 hover:bg-white/20 rounded-xl text-sm font-medium transition-colors">
                Android
              </a>
